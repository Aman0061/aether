      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
          ...
          <div className="grid grid-cols-2 gap-8 text-lg font-light">
            <div>
              <h5 className="uppercase tracking-[0.2em] mb-6 text-neutral-900 text-xl">{t.studio}</h5>
              <p className="mb-1">Bishkek</p>
              <p className="mb-1">Kyrgyzstan</p>
              <p>+(996) 551-968-818</p>
            </div>
            <div>
              <h5 className="uppercase tracking-[0.2em] mb-6 text-neutral-900 text-xl">{t.social}</h5>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-widest text-neutral-400 border-t border-neutral-200 pt-8">
          <p>&copy; 2025 Vimana Architects. {t.rights}</p>
